...
CREATE TABLE `fugitive_emission` (
  ...
  `Battery_No` varchar(45) NOT NULL,
  `PLD` varchar(45) NOT NULL,
  `PLL` varchar(45) NOT NULL,
  `PLO` varchar(45) NOT NULL,
  `Oven_No` varchar(45) NOT NULL,
  `Time` varchar(45) NOT NULL,
  `GCM_Pressure` varchar(45) NOT NULL,
...
INSERT INTO `fugitive_emission` VALUES ('','101','10','5','01','4','0.5','45','mm'),('','4','5','6','2','4','52','2','2'),('','4','5','6','2','4','52','2',''),('','5','5','5','5','6','6','3','5');
